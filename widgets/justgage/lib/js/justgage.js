...
JustGage = function(config) {
  ...
  obj.config = {
    ...
    titleOffsetY: kvLookup('titleOffsetY', config, dataset, 0, 'float'),
    ...
    // valueOffsetY : float
    // value offset up/down
    valueOffsetY: kvLookup('valueOffsetY', config, dataset, 0, 'float'),
    ...
    // mid : float
    // mid value
    mid: kvLookup('mid', config, dataset, 50, 'float'),
    ...
    labelOffsetY: kvLookup('labelOffsetY', config, dataset, 0, 'float'),
    ...
    // pointerMid : bool
    // show value pointer
    pointerMid: kvLookup('pointerMid', config, dataset, false),
  ...
  if (obj.config.pointerMid) {
    // needle
    obj.needleMid = obj.canvas.path().attr({
      "stroke": (obj.config.pointerOptions.stroke !== null && obj.config.pointerOptions.stroke !== undefined) ? obj.config.pointerOptions.stroke : "none",
      "stroke-width": (obj.config.pointerOptions.stroke_width !== null && obj.config.pointerOptions.stroke_width !== undefined) ? obj.config.pointerOptions.stroke_width : 0,
      "stroke-linecap": (obj.config.pointerOptions.stroke_linecap !== null && obj.config.pointerOptions.stroke_linecap !== undefined) ? obj.config.pointerOptions.stroke_linecap : "square",
      "fill": (obj.config.pointerOptions.color !== null && obj.config.pointerOptions.color !== undefined) ? obj.config.pointerOptions.color : "#000000",
    ...
    if (obj.config.donut) {
      obj.needleMid.transform("r" + obj.config.donutStartAngle + ", " + (obj.params.widgetW / 2 + obj.params.dx) + ", " + (obj.params.widgetH / 1.95 + obj.params.dy));
    }

  }

  // title
  obj.txtTitle = obj.canvas.text(obj.params.titleX, obj.params.titleY+obj.config.titleOffsetY, obj.config.title);
  obj.txtTitle.attr({
  ...
  setDy(obj.txtTitle, obj.params.titleFontSize, obj.params.titleY+obj.config.titleOffsetY);

  // value
  obj.txtValue = obj.canvas.text(obj.params.valueX, obj.params.valueY+obj.config.valueOffsetY, 0);
  obj.txtValue.attr({
  ...
  // label
  obj.txtLabel = obj.canvas.text(obj.params.labelX, obj.params.labelY+obj.config.labelOffsetY, obj.config.label);
  obj.txtLabel.attr({
  ...
  obj.txtMin = obj.canvas.text(obj.params.minX, obj.params.minY+obj.config.labelOffsetY, obj.txtMinimum);
  obj.txtMin.attr({
  ...
  obj.txtMax = obj.canvas.text(obj.params.maxX, obj.params.maxY+obj.config.labelOffsetY, obj.txtMaximum);
  obj.txtMax.attr({
    ...
    for (var j = 0; j < colors.length; j++) {
        if (pct <= colors[j].pct) {
            ...
            if (noGradient) {
                ...
                if (fullBri) {
                    colorMax2 = Math.max(color.r, color.g, color.b);
